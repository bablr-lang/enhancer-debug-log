...
export const enhanceGrammarWithDebugLogging = (grammar) => {
...
export const enhanceLanguageWithDebugLogging = memoize((language) => {
  return {
    ...language,
    grammar: enhanceGrammarWithDebugLogging(language.grammar),
  };
});
